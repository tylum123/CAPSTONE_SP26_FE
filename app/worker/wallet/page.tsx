...
const transactions = [
  {
    id: 1,
    type: "in",
    title: "Thanh toán từ công việc",
    description: "Làm đất chuẩn bị vụ mùa",
    amount: "+1,140,000đ",
    date: "12/01/2026",
    status: "completed",
  },
  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 py-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Quản lý số dư và rút tiền</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-br from-agro-orange to-agro-orange-dark text-white overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-4xl font-bold mb-6">{showBalance ? `${balance.toLocaleString()}đ` : "********"}</p>
              <div className="grid grid-cols-2 gap-3">
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Rút tiền về Momo</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Tối thiểu 50,000đ - Tối đa {balance.toLocaleString()}đ
                        </p>
                      </div>
                      <div className="p-3 bg-muted rounded-lg">
                        <p className="text-sm">
                          Số tài khoản Momo: <span className="font-medium">0912 345 678</span>
                        </p>
                      </div>
                      <Button className="w-full bg-pink-500 hover:bg-pink-600 text-white">Xác nhận rút tiền</Button>
                    </div>
                  </DialogContent>
                </Dialog>
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Rút tiền về VNPay</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        <Label>Số tiền rút</Label>
                      ...
                      <div className="p-3 bg-muted rounded-lg">
                        <p className="text-sm">
                          Tài khoản VNPay: <span className="font-medium">****1234</span>
                        </p>
                      </div>
                      <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white">Xác nhận rút tiền</Button>
                    </div>
                  </DialogContent>
                </Dialog>
              </div>
            ...
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-agro-green">1,780,000đ</p>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-agro-orange">900,000đ</p>
                </div>
              </CardContent>
            </Card>
          </div>
